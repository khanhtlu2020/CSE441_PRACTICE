...
public class BanhNgotActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawerLayout = findViewById(R.id.drawer_layout_banhngot);
        NavigationView navigationView = findViewById(R.id.nav_view_banhngot);
        ...
        recyclerViewMon = findViewById(R.id.recyclerViewMon_banhngot);
    ...
    private void loadItemsFromJson() {
        try {
            ...
            JSONArray jsonArray = jsonObj.getJSONArray("banhngot");
