...
public class TraDacBietActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void loadItemsFromJson() {
        try {
            ...
            JSONArray jsonArray = jsonObj.getJSONArray("tradacbiet");
